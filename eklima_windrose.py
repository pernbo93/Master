...
# Remove too small wind speed values!
    ...
    w_H = big_frame.loc[big_frame['station_id'] == 18210] 
    w_B = big_frame.loc[big_frame['station_id'] == 18700] 
...
#A quick way to create new windrose axes...
    ...
    outfilename='eklima_rose_Hovin_25.png'
    ax = new_axes()
    ...
    outfilename2='eklima_rose_Blindern_26.png'
    ax2 = new_axes()
