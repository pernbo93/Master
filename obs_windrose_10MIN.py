...
#A quick way to create new windrose axes...
    ...
    outfilename='obs_rose_Munch_10MIN_10.png'
    ax = new_axes()
    ax.bar(dir_mean_a, ws_10.values, opening=0.8, edgecolor='white', bins=np.arange(0.5, 15, 2))
    plt.title('The Munch Mast - OBS - 10m', y=1.08, fontsize=16, fontweight='bold')
    ax.set_xlim(0,2500)
    ax.set_ylim(0,2500)
    ...
    outfilename2='obs_rose_Munch_10MIN_30.png'
    ax2 = new_axes()
    ax2.bar(dir_mean_b, ws_30.values, opening=0.8, edgecolor='white', bins=np.arange(0.5, 15, 2))
    plt.title('The Munch Mast - OBS - 30m', y=1.08, fontsize=16, fontweight='bold')
    ax2.set_ylim(0,2500)
    ax2.set_xlim(0,2500)
